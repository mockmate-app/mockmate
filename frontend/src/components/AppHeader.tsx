...
export default function AppHeader({
  ...
  return (
    <header
      className={`${sticky ? "sticky top-0 z-30" : ""} ${isDark ? "bg-dark border-white/10" : "bg-light border-border"} border-b h-16 px-4 sm:px-6 flex items-center justify-between shrink-0`}
    >
